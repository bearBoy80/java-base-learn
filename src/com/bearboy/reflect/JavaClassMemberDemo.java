...
public class JavaClassMemberDemo {
    ...
    public static void main(String[] args) {
        ...
        Method[] declaredMethod = ExtendedData.class.getDeclaredMethods();
        Method[] methods = ExtendedData.class.getMethods();
        System.out.println("ExtendedData 类所有的声明字段 : " + Stream.of(declaredMethod).map(Method::getName).collect(Collectors.joining(",")));
        System.out.println("ExtendedData 类所有的 public 字段 : " + Stream.of(methods).map(Method::getName).collect(Collectors.joining(",")));
