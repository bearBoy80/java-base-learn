...
import static com.bearboy.network.SimpleServer.SERVER_CHARSET;
...
public class Chat {
    ...
    public void chatting() throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(socket.getInputStream(), SERVER_CHARSET)); PrintWriter pw = new PrintWriter(new OutputStreamWriter(socket.getOutputStream(), SERVER_CHARSET));) {
